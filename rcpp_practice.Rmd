...
I prefer writing functions in .cpp files over writing inline C++ code with `cppFunction()`.  Writing stand-alone C++ code allows you to use the helpful text editor RStudio supplies (e.g., catches forgotten semicolons, auto indents, pretty colors, etc.)!  However, it's a bit more complicated.   Make sure:
...
## Built-in sum() is unsurprisingly fast, but C++ is close!
